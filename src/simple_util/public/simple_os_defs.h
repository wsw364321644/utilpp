...
SIMPLE_UTIL_API const uint32_t UTIL_CREATE_ALWAYS ;//CREATE_ALWAYS;
SIMPLE_UTIL_API const uint32_t UTIL_CREATE_NEW;// CREATE_NEW;
SIMPLE_UTIL_API const uint32_t UTIL_OPEN_ALWAYS;// OPEN_ALWAYS;
SIMPLE_UTIL_API const uint32_t UTIL_OPEN_EXISTING;// OPEN_EXISTING;
